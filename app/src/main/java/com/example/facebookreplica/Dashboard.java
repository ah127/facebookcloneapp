...
import com.example.facebookreplica.adapters.PostsAdapter;
...
public class Dashboard extends AppCompatActivity {
    ...
    private void viewInit() {
        ...
        String profileimg = Constants.IMAGE_URL + LoginPage.userlist.get(0).getImg();
        ...
        try {
            ...
            postresponse.enqueue(new Callback<List<PostResponse>>() {
                ...
                public void onResponse(Call<List<PostResponse>> call, Response<List<PostResponse>> response) {
                    Toast.makeText(Dashboard.this, response.body().get(0).getMessage(), Toast.LENGTH_SHORT).show();
                    captiontxt.setText("");
